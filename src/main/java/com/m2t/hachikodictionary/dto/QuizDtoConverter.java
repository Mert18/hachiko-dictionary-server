...
public class QuizDtoConverter {
    public QuizDto quizDtoConverter(Quiz from) {
        return new QuizDto(from.getId(), from.getAccount(), from.getCorrectAnswers(), from.getIncorrectAnswers(), from.getDifficulty());
    }

    public Quiz dtoQuizConverter(QuizDto from) {
        return new Quiz(from.getId(), from.getAccount(), from.getCorrectAnswers(), from.getIncorrectAnswers(), from.getDifficulty());
    }
}
